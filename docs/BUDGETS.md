...
| LCP (mobile, slow 4G) | 1807 ms | < 2000 ms | PASS |
| CLS (mobile) | 0.000 | < 0.05 | PASS |
| First-view transfer (gz est.) | 96.7 KB | < 200 KB | PASS |
...
| TBT | 0 ms | 0 ms |
| CLS | 0.000 | 0.004 |
| Total transferred (LH) | 106.2 KB | 106.2 KB |
| Requests (LH) | 16 | 16 |
...
| `app.js` | js | 72.2 KB |
| **Total (raw)** |  | **374.1 KB** |
| **Total (gz est.)** |  | **96.7 KB** |

---

Generated: 2026-07-14T15:43:08.573Z
